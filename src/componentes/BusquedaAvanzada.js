...
function BusquedaAvanzada() {
  ...
  const datosProducto = async () => {
    try {
      ...
      if (combinedData.length > 0 && combinedData[0].categoria && combinedData[0].categoria[0] && combinedData[0].categoria[0].nombre) {
        setCategoriaNombre(combinedData[0].categoria[0].nombre);

        // Ajustar las tallas según la categoría
        if (combinedData[0].categoria[0].nombre === 'Pantalones') {
